		...
		***********************************************************/
		...
		if (!this.bu_icon) {
			...
			if (this.bu_icon == 'none') {
			    this.bu_icon = '/Scripts/plugins/jquery-smoothzoom/zoom_assets/icons.png';
			}
			testOb.remove();
		}		
		...
		this.$image.hide();	
		this.imgList = [
			{ loaded: false, src: this.bu_icon || '/Scripts/plugins/jquery-smoothzoom/zoom_assets/icons.png' }, //Icon image
